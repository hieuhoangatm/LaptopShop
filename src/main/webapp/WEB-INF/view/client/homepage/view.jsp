                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="/images/product/${product.avatar}" class="img-fluid w-100 rounded-top" alt="">
                                            </div>
                                            ...
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                ...
                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                                    <p class="text-dark fs-5 fw-bold mb-0"><fmt:formatNumber value="${product.price}" type="number" maxFractionDigits="2"/></p>
...
<script src="click/lib/easing/easing.min.js"></script>
<script src="click/lib/waypoints/waypoints.min.js"></script>
<script src="click/lib/lightbox/js/lightbox.min.js"></script>
<script src="click/lib/owlcarousel/owl.carousel.min.js"></script>
