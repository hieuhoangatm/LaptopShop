                ...
                <div class="row g-4">
                    <div class="col-lg-6">
                        <div class="border rounded">
                            <a href="#">
                                <img src="/images/product/${product.avatar}" class="img-fluid rounded" alt="Image">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <h5 class="fw-bold mb-3"><fmt:formatNumber value="${product.price}" type="number" maxFractionDigits="2"/></h5>
